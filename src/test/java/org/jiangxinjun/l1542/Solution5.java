    ...
    public int longestAwesome(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            for (int j = 0; j < (i - maxLength + 1); j++) {
                ...
                currentNumSize[jNumericValue]++;
                currentOddBitNumber = currentOddBitNumber + (((numSize[jNumericValue] - currentNumSize[jNumericValue]) & 1) == 1 ? 1 : -1);
